...
def generate_semantic_weights(
    config_path='/mnt/data/liufengyang/mmsegmentation/work_dirs/eval_myvideo_segformer/eval_myvideo_segformer.py',
    checkpoint_path='/mnt/data/liufengyang/mmsegmentation/work_dirs/segformer_b4/best_mIoU_iter_36000.pth',
    image_dir='/mnt/data/liufengyang/data/myvideo/images',
    output_dir='/mnt/data/liufengyang/data/myvideo/semantic_weights',
    device='cuda:0',
    num_classes=2,
):
    assert num_classes == 2, f"[WARNING] generate_semantic_weights.py currently only supports binary segmentation (num_classes=2). Got num_classes={num_classes}. Please adapt fg_prob = probs[1] for multi-class."
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', type=str, default='/mnt/data/liufengyang/mmsegmentation/work_dirs/eval_myvideo_segformer/eval_myvideo_segformer.py')
    parser.add_argument('--checkpoint_path', type=str, default='/mnt/data/liufengyang/mmsegmentation/work_dirs/segformer_b4/best_mIoU_iter_36000.pth')
